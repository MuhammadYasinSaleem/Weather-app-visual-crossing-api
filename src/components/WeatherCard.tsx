      ...
      <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} transition={{ duration: 0.3 }}>
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            ...
            <div className="ml-8">
              <div className="text-7xl font-bold text-white">{Math.round(current.temp)}°</div>
              <p className="text-xl text-slate-300 mt-2">{current.conditions}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <p className="text-2xl font-semibold">{Math.round(current.humidity)}%</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-semibold">
              {current.visibility !== null ? `${Math.round(current.visibility)} km` : 'N/A'}
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-2xl font-semibold">{Math.round(current.feelslike)}°</p>
          </motion.div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-slate-600/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">{Math.round(today.precip || 0)} mm</p>
            </div>
            <div>
